...
## R-8.1 — Dasa order: Kendra, Panaphara, Apoklima groups
...
## R-8.2 — Within-group order: power, then period-length, then rising order
...
## R-8.3 — Antardasa fractions by house from the Dasa lord
...
## R-8.4 — Antardasa fractions reduced to a common denominator
...
## R-8.5 — Sampurna, Rikta, and Ashta — period names by dignity
...
## R-8.6 — Avarohini, Madhyama, Arohini, Adhama — period names by motion and Navamsa
...
## R-8.7 — Misraphala — mixed period names
...
## R-8.8 — Lagna-dasa naming by rising Drekkana and sign-quality
...
## R-8.9 — Naisargika (natural) Dasa order and years
...
## R-8.10 — Prosperity conditions for a Dasa period
...
## R-8.11 — Moon's sign at a Dasa's commencement — flavour of the season
...
## R-8.19 — Benefic, malefic, or mixed period — and the Lagna-dasa
...
## R-8.20 — Metals, occupations, and yoga-fruits within a Dasa
...
## R-8.21 — Complexion and sense-quality of a Dasa by element
...
## R-8.22 — The Divine Soul assumes the season's character
...
## R-8.23 — Conflicting yoga-effects on the same planet
...
## R-8.24 — Udu / Nakshatra (Vimshottari) Dasa — lords, order, years

- **Cites:** Ch 8, translator's N.B. appendix (after v 23)
- **Classification:** table
